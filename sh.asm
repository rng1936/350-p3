...
main(void)
{
       ...
       b:	89 e5                	mov    %esp,%ebp
       d:	53                   	push   %ebx
       e:	bb c0 1c 00 00       	mov    $0x1cc0,%ebx
      13:	51                   	push   %ecx
  ...
  for (int i = 0; i < 10; i++) { // initialize the history buffer
      ...
      2c:	81 fb a8 20 00 00    	cmp    $0x20a8,%ebx
  ...
  memset(buf, 0, nbuf);
      ...
      72:	6a 64                	push   $0x64
      74:	6a 00                	push   $0x0
      76:	68 c0 20 00 00       	push   $0x20c0
      7b:	e8 80 0e 00 00       	call   f00 <memset>
  gets(buf, nbuf);
      80:	58                   	pop    %eax
      81:	5a                   	pop    %edx
      82:	6a 64                	push   $0x64
      84:	68 c0 20 00 00       	push   $0x20c0
      89:	e8 d2 0e 00 00       	call   f60 <gets>
  if(buf[0] == 0) // EOF
      8e:	0f b6 05 c0 20 00 00 	movzbl 0x20c0,%eax
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      a4:	80 3d c1 20 00 00 64 	cmpb   $0x64,0x20c1
    ...
    if (!(buf[0] == 'h' && buf[1] == 'i' && buf[2] == 's' && buf[3] == 't' && buf[4] == ' ')) {
      ca:	80 3d c0 20 00 00 68 	cmpb   $0x68,0x20c0
      d1:	75 0d                	jne    e0 <main+0xe0>
      d3:	80 3d c1 20 00 00 69 	cmpb   $0x69,0x20c1
      da:	0f 84 b8 00 00 00    	je     198 <main+0x198>
  for (int i = 9; i >= 1; i--) {
      e0:	bb 44 20 00 00       	mov    $0x2044,%ebx
  ...
  for (int i = 9; i >= 1; i--) {
      ...
      fa:	81 fb c0 1c 00 00    	cmp    $0x1cc0,%ebx
     100:	75 e6                	jne    e8 <main+0xe8>
  strcpy(history[0], buf);
     102:	83 ec 08             	sub    $0x8,%esp
     105:	68 c0 20 00 00       	push   $0x20c0
     10a:	68 c0 1c 00 00       	push   $0x1cc0
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     140:	80 3d c2 20 00 00 20 	cmpb   $0x20,0x20c2
     147:	0f 85 64 ff ff ff    	jne    b1 <main+0xb1>
      buf[strlen(buf)-1] = 0;  // chop \n
     14d:	83 ec 0c             	sub    $0xc,%esp
     150:	68 c0 20 00 00       	push   $0x20c0
     155:	e8 76 0d 00 00       	call   ed0 <strlen>
      if(chdir(buf+3) < 0)
     15a:	c7 04 24 c3 20 00 00 	movl   $0x20c3,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
     161:	c6 80 bf 20 00 00 00 	movb   $0x0,0x20bf(%eax)
      if(chdir(buf+3) < 0)
     ...
     172:	0f 89 e8 fe ff ff    	jns    60 <main+0x60>
        printf(2, "cannot cd %s\n", buf+3);
     178:	51                   	push   %ecx
     179:	68 c3 20 00 00       	push   $0x20c3
    ...
    if (!(buf[0] == 'h' && buf[1] == 'i' && buf[2] == 's' && buf[3] == 't' && buf[4] == ' ')) {
     198:	80 3d c2 20 00 00 73 	cmpb   $0x73,0x20c2
     19f:	0f 85 3b ff ff ff    	jne    e0 <main+0xe0>
     1a5:	80 3d c3 20 00 00 74 	cmpb   $0x74,0x20c3
     1ac:	0f 85 2e ff ff ff    	jne    e0 <main+0xe0>
     1b2:	80 3d c4 20 00 00 20 	cmpb   $0x20,0x20c4
  ...
  exit();
     ...
     1dd:	68 c0 20 00 00       	push   $0x20c0
...
void updateHist(char *buf) { // maintain history buffer
     ...
     243:	53                   	push   %ebx
     244:	bb 44 20 00 00       	mov    $0x2044,%ebx
     ...
     409:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     42d:	50                   	push   %eax
     42e:	68 a8 1c 00 00       	push   $0x1ca8
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     47d:	50                   	push   %eax
     47e:	68 a8 1c 00 00       	push   $0x1ca8
  ...
  *ps = s;
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4c6:	50                   	push   %eax
     4c7:	68 a0 1c 00 00       	push   $0x1ca0
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4e5:	50                   	push   %eax
     4e6:	68 a8 1c 00 00       	push   $0x1ca8
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     59d:	50                   	push   %eax
     59e:	68 a8 1c 00 00       	push   $0x1ca8
...
00000b60 <runcmd>:
{
  ...
  if(cmd == 0)
     ...
     b6e:	74 23                	je     b93 <runcmd+0x33>
  switch(cmd->type){
     b70:	83 3b 05             	cmpl   $0x5,(%ebx)
     b73:	0f 87 2f 01 00 00    	ja     ca8 <runcmd+0x148>
     b79:	8b 03                	mov    (%ebx),%eax
     b7b:	ff 24 85 2c 16 00 00 	jmp    *0x162c(,%eax,4)
    printf(2, "Backgrounding not implemented\n");
     b82:	50                   	push   %eax
     b83:	50                   	push   %eax
     b84:	68 44 16 00 00       	push   $0x1644
     b89:	6a 02                	push   $0x2
     b8b:	e8 50 06 00 00       	call   11e0 <printf>
    break;
     b90:	83 c4 10             	add    $0x10,%esp
    exit();
     b93:	e8 eb 04 00 00       	call   1083 <exit>
    if (!strcmp(ecmd->argv[0], "hist")) { // all hist commands (print or num) handled here
     b98:	50                   	push   %eax
     b99:	50                   	push   %eax
     b9a:	68 84 15 00 00       	push   $0x1584
     b9f:	ff 73 04             	push   0x4(%ebx)
     ba2:	e8 c9 02 00 00       	call   e70 <strcmp>
     ba7:	83 c4 10             	add    $0x10,%esp
     baa:	85 c0                	test   %eax,%eax
     bac:	0f 84 d1 01 00 00    	je     d83 <runcmd+0x223>
    if(ecmd->argv[0] == 0)
     bb2:	8b 43 04             	mov    0x4(%ebx),%eax
     bb5:	85 c0                	test   %eax,%eax
     bb7:	74 da                	je     b93 <runcmd+0x33>
    exec(ecmd->argv[0], ecmd->argv);
     bb9:	8d 53 04             	lea    0x4(%ebx),%edx
     bbc:	51                   	push   %ecx
     bbd:	51                   	push   %ecx
     bbe:	52                   	push   %edx
     bbf:	50                   	push   %eax
     bc0:	e8 f6 04 00 00       	call   10bb <exec>
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     bc5:	83 c4 0c             	add    $0xc,%esp
     bc8:	ff 73 04             	push   0x4(%ebx)
     bcb:	68 a3 15 00 00       	push   $0x15a3
     bd0:	6a 02                	push   $0x2
     bd2:	e8 09 06 00 00       	call   11e0 <printf>
    break;
     bd7:	83 c4 10             	add    $0x10,%esp
     bda:	eb b7                	jmp    b93 <runcmd+0x33>
    int fd, mode = rcmd->mode;
     bdc:	8b 73 10             	mov    0x10(%ebx),%esi
    char *file = rcmd->file;
     bdf:	8b 7b 08             	mov    0x8(%ebx),%edi
    if (mode == O_WRONLY || mode == (O_WRONLY|O_CREATE)) {
     be2:	89 f0                	mov    %esi,%eax
     be4:	80 e4 fd             	and    $0xfd,%ah
     be7:	83 e8 01             	sub    $0x1,%eax
     bea:	0f 84 5e 01 00 00    	je     d4e <runcmd+0x1ee>
    } else if (mode == O_RDONLY) {
     bf0:	85 f6                	test   %esi,%esi
     bf2:	0f 85 e3 00 00 00    	jne    cdb <runcmd+0x17b>
        fd = open(file, mode);
     bf8:	56                   	push   %esi
     bf9:	56                   	push   %esi
     bfa:	6a 00                	push   $0x0
     bfc:	57                   	push   %edi
     bfd:	e8 c1 04 00 00       	call   10c3 <open>
    if (fd < 0) {
     c02:	83 c4 10             	add    $0x10,%esp
        fd = open(file, mode);
     c05:	89 c6                	mov    %eax,%esi
    if (fd < 0) {
     c07:	85 c0                	test   %eax,%eax
     c09:	0f 88 ca 01 00 00    	js     dd9 <runcmd+0x279>
        close(STDIN_FILENO);
     c0f:	83 ec 0c             	sub    $0xc,%esp
     c12:	6a 00                	push   $0x0
     c14:	e8 92 04 00 00       	call   10ab <close>
        dup(fd);
     c19:	89 34 24             	mov    %esi,(%esp)
     c1c:	e8 da 04 00 00       	call   10fb <dup>
     c21:	83 c4 10             	add    $0x10,%esp
    close(fd);
     c24:	83 ec 0c             	sub    $0xc,%esp
     c27:	56                   	push   %esi
     c28:	e8 7e 04 00 00       	call   10ab <close>
    runcmd(rcmd->cmd);
     c2d:	5a                   	pop    %edx
     c2e:	ff 73 04             	push   0x4(%ebx)
     c31:	e8 2a ff ff ff       	call   b60 <runcmd>
    if (pipe(p) == -1) {
     c36:	83 ec 0c             	sub    $0xc,%esp
     c39:	8d 45 e0             	lea    -0x20(%ebp),%eax
     c3c:	50                   	push   %eax
     c3d:	e8 51 04 00 00       	call   1093 <pipe>
     c42:	83 c4 10             	add    $0x10,%esp
     c45:	83 c0 01             	add    $0x1,%eax
     c48:	0f 84 ea 00 00 00    	je     d38 <runcmd+0x1d8>
    int child_pid1 = fork();
     c4e:	e8 28 04 00 00       	call   107b <fork>
    if (child_pid1 < 0) {
     c53:	85 c0                	test   %eax,%eax
     c55:	78 5e                	js     cb5 <runcmd+0x155>
    } else if (child_pid1 == 0) {
     c57:	0f 84 91 00 00 00    	je     cee <runcmd+0x18e>
    int child_pid2 = fork();
     c5d:	e8 19 04 00 00       	call   107b <fork>
    if (child_pid2 < 0) {
     c62:	85 c0                	test   %eax,%eax
     c64:	78 4f                	js     cb5 <runcmd+0x155>
    } else if (child_pid2 == 0) {
     c66:	0f 84 a7 00 00 00    	je     d13 <runcmd+0x1b3>
    close(p[0]);
     c6c:	83 ec 0c             	sub    $0xc,%esp
     c6f:	ff 75 e0             	push   -0x20(%ebp)
     c72:	e8 34 04 00 00       	call   10ab <close>
    close(p[1]);
     c77:	5a                   	pop    %edx
     c78:	ff 75 e4             	push   -0x1c(%ebp)
     c7b:	e8 2b 04 00 00       	call   10ab <close>
    wait();
     c80:	e8 06 04 00 00       	call   108b <wait>
    wait();
     c85:	e8 01 04 00 00       	call   108b <wait>
    break;
     c8a:	83 c4 10             	add    $0x10,%esp
     c8d:	e9 01 ff ff ff       	jmp    b93 <runcmd+0x33>
    int child_pid = fork();
     c92:	e8 e4 03 00 00       	call   107b <fork>
    if (child_pid < 0) {
     c97:	85 c0                	test   %eax,%eax
     c99:	78 1a                	js     cb5 <runcmd+0x155>
    } else if (child_pid == 0) {
     c9b:	75 2e                	jne    ccb <runcmd+0x16b>
      runcmd(lcmd->left);
     c9d:	83 ec 0c             	sub    $0xc,%esp
     ca0:	ff 73 04             	push   0x4(%ebx)
     ca3:	e8 b8 fe ff ff       	call   b60 <runcmd>
    panic("runcmd");
     ca8:	83 ec 0c             	sub    $0xc,%esp
     cab:	68 7d 15 00 00       	push   $0x157d
     cb0:	e8 db f5 ff ff       	call   290 <panic>
      printf(2, "fork failed\n");
     cb5:	50                   	push   %eax
     cb6:	50                   	push   %eax
     cb7:	68 e1 15 00 00       	push   $0x15e1
     cbc:	6a 02                	push   $0x2
     cbe:	e8 1d 05 00 00       	call   11e0 <printf>
      break;
     cc3:	83 c4 10             	add    $0x10,%esp
     cc6:	e9 c8 fe ff ff       	jmp    b93 <runcmd+0x33>
      wait();
     ccb:	e8 bb 03 00 00       	call   108b <wait>
      runcmd(lcmd->right);
     cd0:	83 ec 0c             	sub    $0xc,%esp
     cd3:	ff 73 08             	push   0x8(%ebx)
     cd6:	e8 85 fe ff ff       	call   b60 <runcmd>
        printf(2, "Unsupported redirection mode\n");
     cdb:	53                   	push   %ebx
     cdc:	53                   	push   %ebx
     cdd:	68 b3 15 00 00       	push   $0x15b3
     ce2:	6a 02                	push   $0x2
     ce4:	e8 f7 04 00 00       	call   11e0 <printf>
        exit();
     ce9:	e8 95 03 00 00       	call   1083 <exit>
      close(1);
     cee:	83 ec 0c             	sub    $0xc,%esp
     cf1:	6a 01                	push   $0x1
     cf3:	e8 b3 03 00 00       	call   10ab <close>
      dup(p[1]);
     cf8:	58                   	pop    %eax
     cf9:	ff 75 e4             	push   -0x1c(%ebp)
     cfc:	e8 fa 03 00 00       	call   10fb <dup>
      close(p[0]);
     d01:	58                   	pop    %eax
     d02:	ff 75 e0             	push   -0x20(%ebp)
     d05:	e8 a1 03 00 00       	call   10ab <close>
      runcmd(pcmd->left);
     d0a:	58                   	pop    %eax
     d0b:	ff 73 04             	push   0x4(%ebx)
     d0e:	e8 4d fe ff ff       	call   b60 <runcmd>
      close(0);
     d13:	83 ec 0c             	sub    $0xc,%esp
     d16:	6a 00                	push   $0x0
     d18:	e8 8e 03 00 00       	call   10ab <close>
      dup(p[0]);
     d1d:	59                   	pop    %ecx
     d1e:	ff 75 e0             	push   -0x20(%ebp)
     d21:	e8 d5 03 00 00       	call   10fb <dup>
      close(p[1]);
     d26:	5e                   	pop    %esi
     d27:	ff 75 e4             	push   -0x1c(%ebp)
     d2a:	e8 7c 03 00 00       	call   10ab <close>
      runcmd(pcmd->right);
     d2f:	5f                   	pop    %edi
     d30:	ff 73 08             	push   0x8(%ebx)
     d33:	e8 28 fe ff ff       	call   b60 <runcmd>
      printf(2, "pipe failed\n");
     d38:	50                   	push   %eax
     d39:	50                   	push   %eax
     d3a:	68 ee 15 00 00       	push   $0x15ee
     d3f:	6a 02                	push   $0x2
     d41:	e8 9a 04 00 00       	call   11e0 <printf>
      break;
     d46:	83 c4 10             	add    $0x10,%esp
     d49:	e9 45 fe ff ff       	jmp    b93 <runcmd+0x33>
        unlink(file);
     d4e:	83 ec 0c             	sub    $0xc,%esp
     d51:	57                   	push   %edi
     d52:	e8 7c 03 00 00       	call   10d3 <unlink>
        fd = open(file, mode);
     d57:	58                   	pop    %eax
     d58:	5a                   	pop    %edx
     d59:	56                   	push   %esi
     d5a:	57                   	push   %edi
     d5b:	e8 63 03 00 00       	call   10c3 <open>
    if (fd < 0) {
    ...
    if (fd < 0) {
     ...
     d67:	78 70                	js     dd9 <runcmd+0x279>
        close(STDOUT_FILENO);
     d69:	83 ec 0c             	sub    $0xc,%esp
     d6c:	6a 01                	push   $0x1
     d6e:	e8 38 03 00 00       	call   10ab <close>
        dup(fd);
     d73:	89 34 24             	mov    %esi,(%esp)
     d76:	e8 80 03 00 00       	call   10fb <dup>
     d7b:	83 c4 10             	add    $0x10,%esp
     d7e:	e9 a1 fe ff ff       	jmp    c24 <runcmd+0xc4>
      if(!strcmp(ecmd->argv[1], "print")) {
     d83:	50                   	push   %eax
     d84:	50                   	push   %eax
     d85:	68 89 15 00 00       	push   $0x1589
     d8a:	ff 73 08             	push   0x8(%ebx)
     d8d:	e8 de 00 00 00       	call   e70 <strcmp>
     d92:	83 c4 10             	add    $0x10,%esp
     d95:	89 c6                	mov    %eax,%esi
     d97:	85 c0                	test   %eax,%eax
     d99:	74 0b                	je     da6 <runcmd+0x246>
     d9b:	eb 4f                	jmp    dec <runcmd+0x28c>
        for (int i = 0; i < 10; i++) {
     d9d:	83 fe 0a             	cmp    $0xa,%esi
     da0:	0f 84 ed fd ff ff    	je     b93 <runcmd+0x33>
          if (strcmp(history[i], "empty")) {
     da6:	6b de 64             	imul   $0x64,%esi,%ebx
     da9:	57                   	push   %edi
            printf(1, "%d. %s", i+1, history[i]);
     daa:	83 c6 01             	add    $0x1,%esi
          if (strcmp(history[i], "empty")) {
     dad:	57                   	push   %edi
     dae:	68 8f 15 00 00       	push   $0x158f
     db3:	81 c3 c0 1c 00 00    	add    $0x1cc0,%ebx
     db9:	53                   	push   %ebx
     dba:	e8 b1 00 00 00       	call   e70 <strcmp>
     dbf:	83 c4 10             	add    $0x10,%esp
     dc2:	85 c0                	test   %eax,%eax
     dc4:	74 d7                	je     d9d <runcmd+0x23d>
            printf(1, "%d. %s", i+1, history[i]);
     dc6:	53                   	push   %ebx
     dc7:	56                   	push   %esi
     dc8:	68 95 15 00 00       	push   $0x1595
     dcd:	6a 01                	push   $0x1
     dcf:	e8 0c 04 00 00       	call   11e0 <printf>
     dd4:	83 c4 10             	add    $0x10,%esp
     dd7:	eb c4                	jmp    d9d <runcmd+0x23d>
        printf(2, "open %s failed\n", file);
     dd9:	51                   	push   %ecx
     dda:	57                   	push   %edi
     ddb:	68 d1 15 00 00       	push   $0x15d1
     de0:	6a 02                	push   $0x2
     de2:	e8 f9 03 00 00       	call   11e0 <printf>
        exit();
     de7:	e8 97 02 00 00       	call   1083 <exit>
        int historyIndex = atoi(ecmd->argv[1])-1; //hist <num> commands handled here, parsed like other commands
     dec:	83 ec 0c             	sub    $0xc,%esp
     def:	ff 73 08             	push   0x8(%ebx)
     df2:	e8 19 02 00 00       	call   1010 <atoi>
        if (historyIndex >= 0 && historyIndex <= 9) {
     df7:	83 c4 10             	add    $0x10,%esp
        int historyIndex = atoi(ecmd->argv[1])-1; //hist <num> commands handled here, parsed like other commands
     dfa:	83 e8 01             	sub    $0x1,%eax
        if (historyIndex >= 0 && historyIndex <= 9) {
     dfd:	83 f8 09             	cmp    $0x9,%eax
     e00:	77 19                	ja     e1b <runcmd+0x2bb>
          runcmd(parsecmd(history[historyIndex]));
     e02:	6b c0 64             	imul   $0x64,%eax,%eax
     e05:	83 ec 0c             	sub    $0xc,%esp
     e08:	05 c0 1c 00 00       	add    $0x1cc0,%eax
     e0d:	50                   	push   %eax
     e0e:	e8 dd fc ff ff       	call   af0 <parsecmd>
     e13:	89 04 24             	mov    %eax,(%esp)
     e16:	e8 45 fd ff ff       	call   b60 <runcmd>
          printf(2, "usage\n");
     e1b:	53                   	push   %ebx
     e1c:	53                   	push   %ebx
     e1d:	68 9c 15 00 00       	push   $0x159c
     e22:	6a 02                	push   $0x2
     e24:	e8 b7 03 00 00       	call   11e0 <printf>
          break;
     e29:	83 c4 10             	add    $0x10,%esp
     e2c:	e9 62 fd ff ff       	jmp    b93 <runcmd+0x33>
     e31:	66 90                	xchg   %ax,%ax
    ...
    1148:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    117b:	0f b6 92 c4 16 00 00 	movzbl 0x16c4(%edx),%edx
    ...
    11e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1254:	ff 24 85 6c 16 00 00 	jmp    *0x166c(,%eax,4)
  ...
  write(fd, &c, 1);
    ...
    1380:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1385:	bb 63 16 00 00       	mov    $0x1663,%ebx
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1391:	a1 24 21 00 00       	mov    0x2124,%eax
{
  ...
  freep = p;
    ...
    13d1:	5b                   	pop    %ebx
  freep = p;
    13d2:	89 15 24 21 00 00    	mov    %edx,0x2124
}
    13d8:	5e                   	pop    %esi
    13d9:	5f                   	pop    %edi
    13da:	5d                   	pop    %ebp
  ...
  freep = p;
    140a:	89 15 24 21 00 00    	mov    %edx,0x2124
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    142c:	8b 15 24 21 00 00    	mov    0x2124,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    146b:	39 05 24 21 00 00    	cmp    %eax,0x2124
  ...
  return freep;
    1493:	8b 15 24 21 00 00    	mov    0x2124,%edx
    ...
    14bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    14bf:	89 15 24 21 00 00    	mov    %edx,0x2124
}
    ...
    14cf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    14d0:	c7 05 24 21 00 00 28 	movl   $0x2128,0x2124
    14d7:	21 00 00 
    base.s.size = 0;
    14da:	b8 28 21 00 00       	mov    $0x2128,%eax
    base.s.ptr = freep = prevp = &base;
    14df:	c7 05 28 21 00 00 28 	movl   $0x2128,0x2128
    14e6:	21 00 00 
    base.s.size = 0;
    14e9:	c7 05 2c 21 00 00 00 	movl   $0x0,0x212c
    14f0:	00 00 00 
    if(p->s.size >= nunits){
